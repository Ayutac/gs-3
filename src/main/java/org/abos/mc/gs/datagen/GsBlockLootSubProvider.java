...
public class GsBlockLootSubProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        dropSelf(GsBlocks.TILED_INFUSED_STONE.get());
        dropSelf(GsBlocks.TILED_INFUSED_STONE_STAIRS.get());
        dropSelf(GsBlocks.TILED_INFUSED_STONE_SLAB.get());
        dropSelf(GsBlocks.TILED_INFUSED_STONE_WALL.get());
